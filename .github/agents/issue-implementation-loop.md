...
7. Make narrow changes that satisfy the selected issue. Count implementation attempts and stop before a third failed attempt; create/comment a human-review off-ramp instead of continuing inefficiently.
